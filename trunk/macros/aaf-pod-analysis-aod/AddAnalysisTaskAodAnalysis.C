void AddAnalysisTaskAodAnalysis(TString format="esd",Bool_t useMC = kFALSE,TString opts="")
{
  // create manager
  ...
  AliAnalysisDataContainer *output1 = mgr->CreateContainer("cCustomList", TList::Class(), AliAnalysisManager::kOutputContainer, Form("MyAODANOutput%s.root",opts.Data()));
