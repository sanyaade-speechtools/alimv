...
AliAnalysisTask* AddRsnTaskMix(TString format="esd",Bool_t useMC = kFALSE,TString opts="")
{
...
// 	const char *configMacro = "ConfigTaskRsnTest_SimpleMix.C";
  ...
  AliRsnAnalysisMulti *task = new AliRsnAnalysisMulti("RsnMixingTask");
...
//   task->SelectCollisionCandidates();
  ...
  AliAnalysisDataContainer *outputInfo = mgr->CreateContainer("RsnInfoMix", TList::Class(), AliAnalysisManager::kOutputContainer, commonPath);
  AliAnalysisDataContainer *outputHist = mgr->CreateContainer("RsnHistMix", TList::Class(), AliAnalysisManager::kOutputContainer, commonPath);
