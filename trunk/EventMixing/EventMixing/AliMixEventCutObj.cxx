...
void AliMixEventCutObj::Print(const Option_t *) const
{
    ...
    //
    AliInfo(Form("%s %f %f %f", GetNameOfCut(fCutType), fCutMin, fCutMax, fCutStep));
}
//_________________________________________________________________________________________________
void AliMixEventCutObj::PrintCurrentInterval()
{
    ...
    //
    AliDebug(AliLog::kDebug,Form("%s <%f,%f>", GetNameOfCut(fCutType), GetMin(), GetMax()));
}
...
//_________________________________________________________________________________________________
const char *AliMixEventCutObj::GetNameOfCut(Int_t index) const
{
    //
    // Retruns name of cut
    //
