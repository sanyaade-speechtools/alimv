...
ClassImp(AliRsnVAnalysisTaskMulti)

//_____________________________________________________________________________
AliRsnVAnalysisTaskMulti::AliRsnVAnalysisTaskMulti
...
//_____________________________________________________________________________
AliRsnVAnalysisTaskMulti::AliRsnVAnalysisTaskMulti(const AliRsnVAnalysisTaskMulti& copy) :
  AliAnalysisTaskMulti(copy),
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::LocalInit()
{
//
...
//
  ...
  AliAnalysisTaskMulti::LocalInit();
}

//_____________________________________________________________________________
Bool_t AliRsnVAnalysisTaskMulti::UserNotify()
{
//
// Calls the mother class Notify()
//

  return AliAnalysisTaskMulti::UserNotify();
}

//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::ConnectInputData(Option_t *opt)
{
//
...
// 
  ...
  AliAnalysisTaskMulti::ConnectInputData(opt);
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::UserCreateOutputObjects()
{
//
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::UserExec(Option_t* opt)
{
//
...
void AliRsnVAnalysisTaskMulti::UserExecMix(Option_t* option)
{
    AliDebug(AliLog::kDebug+2,"<-");
    ...
    // both static pointers of AliRsnEvent class 
    // will point to the same unique datamember
    AliRsnEvent::SetCurrentEvent1(&fRsnEvent[0], CurrentEntryMain());
    AliRsnEvent::SetCurrentEvent2(&fRsnEvent[1], CurrentEntryMix());
    AliRsnTarget::SwitchToFirst();
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::Terminate(Option_t* opt)
{
//
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::RsnUserCreateOutputObjects()
{
//
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::RsnUserExec(Option_t*)
{
//
//
//
...
void AliRsnVAnalysisTaskMulti::RsnUserExecMix(Option_t* )
{
  //
  //
  //
...
//_____________________________________________________________________________
void AliRsnVAnalysisTaskMulti::RsnTerminate(Option_t*)
{
//
...
//_____________________________________________________________________________
Bool_t AliRsnVAnalysisTaskMulti::EventProcess()
{
//
...
void AliRsnVAnalysisTaskMulti::SetupMixingEvents()
{
  // mixing setup
  ...
  if(inEvHMain) {
    ...
    if(mixEH) {
      AliMultiInputEventHandler *inEvHMainTmpMix = dynamic_cast<AliMultiInputEventHandler *>(mixEH->InputEventHandler(0));
