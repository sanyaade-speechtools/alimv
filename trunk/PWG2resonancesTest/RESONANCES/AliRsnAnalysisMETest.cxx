...
#include "AliRsnAnalysisMETest.h"

ClassImp(AliRsnAnalysisMETest)

//_____________________________________________________________________________
AliRsnAnalysisMETest::AliRsnAnalysisMETest(const char *name) :
...
AliRsnAnalysisMETest::AliRsnAnalysisMETest(const AliRsnAnalysisMETest& copy) : AliRsnVAnalysisTaskME(copy),
...
//_____________________________________________________________________________
void AliRsnAnalysisMETest::RsnUserCreateOutputObjects()
{
//
// TODO
//
...
void AliRsnAnalysisMETest::RsnUserExec(Option_t*)
{
//
// TODO
//
...
//_____________________________________________________________________________
void AliRsnAnalysisMETest::RsnTerminate(Option_t*)
{
//
// TODO
//
...
//_____________________________________________________________________________
AliRsnAnalysisManager* AliRsnAnalysisMETest::GetAnalysisManager(TString name)
{
//
...
//_____________________________________________________________________________
void AliRsnAnalysisMETest::SetPriorProbability(AliPID::EParticleType type, Double_t p)
{
  //
...
//_____________________________________________________________________________
void AliRsnAnalysisMETest::DumpPriors()
{
  //
...
//_____________________________________________________________________________
void AliRsnAnalysisMETest::GetPriorProbability(Double_t *out) const
{
//
// Gets all prior probabilities to out
//
