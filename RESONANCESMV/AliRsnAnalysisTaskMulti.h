#ifndef ALIRSNANALYSISTASKMULTI_H
#define ALIRSNANALYSISTASKMULTI_H
...
class TList;
class AliMixInfo;
class AliRsnAnalysisTaskMulti : public AliAnalysisTaskMulti
{
public:
    AliRsnAnalysisTaskMulti(const char *name="<default name>");
    virtual ~AliRsnAnalysisTaskMulti();
...
private:
    ...
    AliRsnAnalysisTaskMulti(const AliRsnAnalysisTaskMulti &); // not implemented
    AliRsnAnalysisTaskMulti &operator=(const AliRsnAnalysisTaskMulti &); // not implemented

    ClassDef(AliRsnAnalysisTaskMulti, 1); // example of analysis
};
