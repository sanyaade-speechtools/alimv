...
#include "AliRsnAnalysisMulti.h"

ClassImp(AliRsnAnalysisMulti)

//_____________________________________________________________________________
AliRsnAnalysisMulti::AliRsnAnalysisMulti(const char *name, Bool_t useKine) :
...
//_____________________________________________________________________________
AliRsnAnalysisMulti::AliRsnAnalysisMulti(const AliRsnAnalysisMulti& copy) :
...
//_____________________________________________________________________________
AliRsnAnalysisMulti& AliRsnAnalysisMulti::operator=(const AliRsnAnalysisMulti& copy)
{
//
// Assigment operator.
//
...
//_____________________________________________________________________________
void AliRsnAnalysisMulti::RsnUserCreateOutputObjects()
{
//
...
//_____________________________________________________________________________
void AliRsnAnalysisMulti::RsnUserExec(Option_t*)
{
//
...
void AliRsnAnalysisMulti::RsnUserExecMix(Option_t* /*opt*/)
{
  if (!IsMixing()) return;
...
//_____________________________________________________________________________
void AliRsnAnalysisMulti::RsnTerminate(Option_t*)
{
//
// Termination.
...
Bool_t AliRsnAnalysisMulti::EventProcess()
{
//
...
//
  ...
  return AliRsnVAnalysisTaskMulti::EventProcess();
}
